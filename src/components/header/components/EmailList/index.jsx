...
class EmailList extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            emails: [
                {id: 1, primary: '苏轼', secondary: '会挽雕弓如满月，西北望···', time: '15:31 PM'},
                {id: 2, primary: '李白', secondary: '天生我材必有用,千金散尽···', time: '14:25 PM'},
                {id: 3, primary: '杜甫', secondary: '会当凌绝顶,一览众山小···', time: '10:43 AM'},
                {id: 4, primary: '诸葛亮', secondary: '非淡泊无以明志，非宁静无...', time: '09:56 AM'},
                {id: 5, primary: '岳飞', secondary: '三十功名尘与土，八千里路...', time: '08:47 AM'},
            ]
        };
    }
                        ...
                        <List>
                            {
                                this.state.emails.map(item => {
                                    return <ListItem key={item.id} button className={classes.item}>
                                        <ListItemAvatar>
                                            <Avatar alt="Profile Picture" src='assets/5.jpg' />
                                        </ListItemAvatar>
